 ...
 * 
 * The performance scores are retrieved during build in 11ty's _data/performance.js which calls the lambda 
 * which does the evaluations on a daily cron and stores results in dynamodb
*/
